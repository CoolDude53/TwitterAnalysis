...
public class CondensedWriter
{
    ...
    private static void write(WordList list, File file) throws IOException
    {
    ...
    private static void convert(File in, File out, WordListLoader loader) throws IOException
    {
